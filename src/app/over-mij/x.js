...
export default function OverMij() {
  ...
  return (
    <div className="min-h-screen w-half bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center p-4 relative overflow-hidden">

      <Card className="w-full max-w-4xl z-10 bg-white/80 backdrop-blur-md shadow-xl">
      ...
      <Card className="w-full max-w-4xl z-10 bg-white/80 backdrop-blur-md shadow-xl mt-8">
  <CardHeader className="pb-2">
